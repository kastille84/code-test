...
const Map: React.FC<MapProps> = ({location, name}) => {
  ...
  const GoogleMapComp = withGoogleMap(props => (
    ...
    >
      ...
      >
        {isOpen && 
          <InfoBox position={{lat: location.lat, lng: location.lng}} options={{closeBoxURL:``, enableEventPropagation: true}}>
            <div style={{backgroundColor: '#43b379', padding: '12px', minWidth: '100px', opacity: '0.9'}}>
